...
> **Note:** Planning methodology is in `agents/index-planner.md`.-indo
...
@C:\Users\Rekabit\.claude/agents/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@C:\Users\Rekabit\.claude/agents/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @C:\Users\Rekabit\.claude/agents/references/checkpoints.md -->
...
See `C:\Users\Rekabit\.claude/agents/references/tdd.md` for TDD plan structure.
...
See `C:\Users\Rekabit\.claude/agents/templates/user-setup.md` for full schema and examples
...
See `C:\Users\Rekabit\.claude/agents/workflows/verify-phase.md` for verification logic.
