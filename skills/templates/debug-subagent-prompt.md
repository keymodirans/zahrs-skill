...
Template for spawning index-debugger-indo agent. The agent contains all debugging expertise - this template provides problem context only.
...
Task(
  ...
  subagent_type="index-debugger-indo",
...
```python
Task(prompt=template, subagent_type="index-debugger-indo", description="Debug UAT-001")
```
