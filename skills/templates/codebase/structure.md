...
│   └── index/         # INDEX-specific commands
├── agents/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/index/{command-name}.md`
...
- Usage: Reference from command with `@C:\Users\Rekabit\.claude/agents/workflows/{name}.md`
...
**agents/**
- Purpose: Resources installed to C:\Users\Rekabit\.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:\Users\Rekabit\.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
