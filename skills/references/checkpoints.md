...
- Assume knowledge: "Configure the usual settings" [X]
- Skip steps: "Set up database" [X] (too vague)
...
**Bad placement:**
- Before Claude automates (asking human to do automatable work) [X]
- Too frequent (every other task is a checkpoint) [X]
- Too late (checkpoint is last task, but earlier tasks needed its result) [X]
</writing_guidelines>
...
### [X] BAD: Asking user to start dev server
...
### [OK] GOOD: Claude starts server, user visits
...
### [X] BAD: Asking user to add env vars in dashboard
...
### [OK] GOOD: Claude collects secret, adds via CLI
...
### [OK] GOOD: Claude automates, human verifies
...
### [OK] GOOD: Single verification checkpoint
...
### [X] BAD: Asking for automatable file operations
...
### [X] BAD: Vague verification steps
...
### [OK] GOOD: Specific verification steps (server already running)
...
### [X] BAD: Asking user to run any CLI command
...
### [X] BAD: Asking user to copy values between services
